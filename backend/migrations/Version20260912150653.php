 ...
 */
final class Version20260912150653 extends AbstractMigration
{
    public function getDescription(): string
    {
        return "Expiration facultative des clés d'accès (prof / admin)";
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE access_key ADD COLUMN expires_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__access_key AS SELECT id, value, role, label, created_by, created_at, revoked_at, last_used_at, usage_count, assigned_to_name, assigned_to_id FROM access_key');
        ...
        $this->addSql('INSERT INTO access_key (id, value, role, label, created_by, created_at, revoked_at, last_used_at, usage_count, assigned_to_name, assigned_to_id) SELECT id, value, role, label, created_by, created_at, revoked_at, last_used_at, usage_count, assigned_to_name, assigned_to_id FROM __temp__access_key');
